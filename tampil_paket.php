...
<body>
<h3>Tampil Cucian | <a href="tambah_paket.php" class="btn btn-primary">Tambah Paket</a></h3>
...
?>
  <tr>
    ...
    <td><a href="ubah_paket.php?id_paket=<?=$data_paket['id_paket']?>" class="btn btn-success">Ubah</a> | <a 
